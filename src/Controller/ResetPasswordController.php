    ...
    public function index(Request $request): Response
    {
        ...
        if ($request->get('email')) {
            ...
            if ($user) {
                ...
                $content = "Bonjour ".$user->getFirstname().",<br/>Vous avez demandé à réinitialiser votre mot de passe sur le site La Boutique Française<br/><br/>Merci de bien vouloir cliquer sur le lien suivant afin de <a href='".$url."'>mettre à jour votre mot de passe</a>.";
